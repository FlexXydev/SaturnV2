const {SlashCommandBuilder, PermissionsBitField} = require("discord.js"); 
 ...
 module.exports = { 
   ...
   data: new SlashCommandBuilder() 
     ...
     .addStringOption(option => option.setName("tweet").setDescription("Specified tweet message will be used for the spoof.").setRequired(true).setMaxLength(100)) 
     ...
     async execute (interaction) { 
       ...
       if (!interaction.member.permissions.has(PermissionsBitField.Flags.ManageMessages) && interaction.user.id !== '310107091542999040') return await interaction.reply({ content: 'You **do not** have the permission to do that!', ephemeral: true}); 
